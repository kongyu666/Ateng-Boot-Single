package io.github.kongyu666.common.aspect;
...
import io.github.kongyu666.common.enums.BusinessStatus;
import io.github.kongyu666.common.utils.JsonUtils;
import io.github.kongyu666.common.utils.ServletUtils;
import io.github.kongyu666.common.utils.SpringUtils;
import io.github.kongyu666.common.utils.StringUtils;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            // *========数据库日志=========*//
            SysLogOperate operLog = new SysLogOperate();
            // 设置用户信息
            SysUserVo userInfo;
            try {
                SaSession session = StpUtil.getSession();
                userInfo = JSONObject.parseObject(session.getString("userInfo")).toJavaObject(SysUserVo.class);
            } catch (Exception ex) {
                return;
            }
            ...
            if (e != null) {
                ...
                operLog.setErrorMsg(ExceptionUtil.stacktraceToString(e, 10000));
            }
            // 设置方法名称
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysLogOperate operLog, Object jsonResult) throws Exception {
        // 设置action动作
        operLog.setType(log.type());
        // 设置模块
        operLog.setModule(log.module());
        // 设置描述
        operLog.setDescribe(log.desc());
        // 是否需要保存request，参数和值
     ...
     * @throws Exception 异常
     */
    private void setRequestValue(JoinPoint joinPoint, SysLogOperate operLog, String[] excludeParamNames) throws Exception {
